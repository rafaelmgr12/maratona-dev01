...
const Storage = {
  get(){
    return JSON.parse(localStorage.getItem("Rafael.appdev.finance:transactions"))
  },
  set(transactions){
    localStorage.setItem("Rafael.appdev.finance:transactions", JSON.stringify(transactions))
  },
}
